...
public class CentralPacientes {
    ...
    {
        Paciente seleccionado = primero;
        int cuentaHombres = 0;
        while (seleccionado != null)
        {
            if (seleccionado.darSexo() == Paciente.HOMBRE)
            {
                cuentaHombres += 1;
            }
            seleccionado = seleccionado.darSiguiente();
        }
    ...
    {
        Paciente seleccionada = primero;
        int cuentaMujeres = 0;
        while ( seleccionada != null )
        {
            if (seleccionada.darSexo() == Paciente.MUJER)
            {
                cuentaMujeres += 1;
            }
            seleccionada = seleccionada.darSiguiente();
        }
